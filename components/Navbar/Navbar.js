...
export default function Navbar() {
    ...
    return (
        <nav className={styles.navbar}>
            ...
            <svg onClick={(e) => hideMiniMenu(e)} id='closeMiniMenu' xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className={styles.closeMiniMenu} viewBox="0 0 16 16">
            ...
            <div ref={socialRef} className={styles.social}>
                ...
                <a onClick={() => hideMiniMenu()} href='https://www.instagram.com/' target='_blank' rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className={styles.socialItem} viewBox="0 0 16 16">
