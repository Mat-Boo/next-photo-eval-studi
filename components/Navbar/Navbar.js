...
export default function Navbar() {
    ...
    return (
        <nav className={styles.navbar}>
            <Link href='/'>
                <a>
                    <img src='/resources/LogoNavbar.png' alt='logo' className={styles.logoNav}/>
                </a>
            </Link>
            ...
            <svg onClick={(e) => hideMiniMenu(e)} xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className={styles.closeMiniMenu} viewBox="0 0 16 16">
            ...
            <div ref={menuRef} className= {styles.menuAndSocial}>
                <div className={styles.menu}>
                    ...
                    <ActiveLink href='/galerie'>
                        <div onClick={(e) => hideMiniMenu(e)}>
                                GALERIE
                        </div>
                    </ActiveLink>
                    <ActiveLink href='/prestations'>
                        <div onClick={(e) => hideMiniMenu(e)}>
                                PRESTATIONS
                        </div>
                    </ActiveLink>
                ...
                <div className={styles.social}>
                    <a onClick={() => hideMiniMenu()} href='https://www.facebook.com/' target='_blank'>
                    ...
                    <a onClick={() => hideMiniMenu()} href='https://www.instagram.com/' target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className={styles.socialItem} viewBox="0 0 16 16">
