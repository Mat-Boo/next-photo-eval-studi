    ...
    return (
        <div ref={policyRef} className={styles.privacyPolicy}>
            ...
            <div className={styles.policyText}>
                ...
                <p>Charles Cantin Photographe, Charles Cantin, 15 rue de là-bas, 62000 Arras, France, SIREN: 123 456 789, SIRET: 12345678900012,  est responsable du traitement de vos données collectées sur son site Internet <b><a href="https://charles-cantin.studi.auxseen.com/">https://charles-cantin.studi.auxseen.com/</a></b> (formulaire de contact, questionnaire et signature de contrat).</p>
